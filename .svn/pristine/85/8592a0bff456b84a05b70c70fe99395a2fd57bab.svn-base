...
@Embeddable
public class ProyectLoanPK 
implements Serializable
{
	private static final long serialVersionUID = 1862691405033536822L;

	@Column private int proyect_loan_id;	
	@Column private int proyect_id;	
	@Column private int prospectus_id;	
	@Column private int company_id;		
	
	public ProyectLoanPK()
	{
		super();
	}
	
	public ProyectLoanPK(int proyect_loan_id, int proyect_id, int prospectus_id, int company_id )
	{
