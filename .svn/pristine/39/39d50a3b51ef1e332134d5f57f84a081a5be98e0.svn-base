/**
 * AltaConocimientoCteResponse.java
 *
...
public class AltaConocimientoCteResponse  implements java.io.Serializable {
    private java.lang.String codigoRespuesta;

    private java.lang.String mensajeRespuesta;

    public AltaConocimientoCteResponse() {
    }
    ...
    /**
     * Gets the codigoRespuesta value for this AltaConocimientoCteResponse.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this AltaConocimientoCteResponse.
     * 
    ...
    /**
     * Gets the mensajeRespuesta value for this AltaConocimientoCteResponse.
     * 
    ...
    /**
     * Sets the mensajeRespuesta value for this AltaConocimientoCteResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AltaConocimientoCteResponse)) return false;
        AltaConocimientoCteResponse other = (AltaConocimientoCteResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AltaConocimientoCteResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://safisrv/ws/schemas", ">altaConocimientoCteResponse"));
