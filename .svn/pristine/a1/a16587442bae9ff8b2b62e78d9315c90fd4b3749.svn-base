...
public class SAFIServiciosServiceLocator extends org.apache.axis.client.Service implements safisrv.ws.CreditosServicios.SAFIServiciosService {
    ...
    public safisrv.ws.CreditosServicios.SAFIServicios getSAFIServiciosSoap11() throws javax.xml.rpc.ServiceException {
    ...
    public safisrv.ws.CreditosServicios.SAFIServicios getSAFIServiciosSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            safisrv.ws.CreditosServicios.SAFIServiciosSoap11Stub _stub = new safisrv.ws.CreditosServicios.SAFIServiciosSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (safisrv.ws.CreditosServicios.SAFIServicios.class.isAssignableFrom(serviceEndpointInterface)) {
                safisrv.ws.CreditosServicios.SAFIServiciosSoap11Stub _stub = new safisrv.ws.CreditosServicios.SAFIServiciosSoap11Stub(new java.net.URL(SAFIServiciosSoap11_address), this);
                _stub.setPortName(getSAFIServiciosSoap11WSDDServiceName());
                return _stub;
            }
        }
