...
//    	genderCad = genderCad.substring( ("gender:").length() );
	...
	protected void preparaProyectList( FilterStore filter, int prospectus_id, int company_id, String safi_account ){
		...
		createProyectListView(temporalProyectListView, prospectus_id,  company_id, safi_account);
...
//				
//				if( profileformvalueservice.getHaInvertidoEnAcciones(prospectus_id, company_id) ){
//					puedeInvertire_en_F_G = true;
//				}
//				
//			}
