/**
 * AltaConocimientoCtaResponse.java
 *
...
public class AltaConocimientoCtaResponse  implements java.io.Serializable {
    private java.lang.String codigoRespuesta;

    private java.lang.String mensajeRespuesta;

    public AltaConocimientoCtaResponse() {
    }
    ...
    /**
     * Gets the codigoRespuesta value for this AltaConocimientoCtaResponse.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this AltaConocimientoCtaResponse.
     * 
    ...
    /**
     * Gets the mensajeRespuesta value for this AltaConocimientoCtaResponse.
     * 
    ...
    /**
     * Sets the mensajeRespuesta value for this AltaConocimientoCtaResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AltaConocimientoCtaResponse)) return false;
        AltaConocimientoCtaResponse other = (AltaConocimientoCtaResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AltaConocimientoCtaResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://safisrv/ws/schemas", ">altaConocimientoCtaResponse"));
