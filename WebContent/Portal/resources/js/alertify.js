	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				ok     : "<span class=\"alertify-button alertify-button-ok\" id=\"alertify-ok\">{{ok}}</span>",
				cancel : "<span class=\"alertify-button alertify-button-cancel\" id=\"alertify-cancel\">{{cancel}}</span>"
			},
