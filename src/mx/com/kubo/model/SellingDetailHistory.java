...
@Entity
@Table(name="gn_selling_detail_history")
public class SellingDetailHistory implements Serializable {
	...
	@EmbeddedId
	  private SellingDetailHistoryPK pk;
	  @Column
	...
	public SellingDetailHistoryPK getPk() {
		return pk;
	}
	public void setPk(SellingDetailHistoryPK pk) {
		this.pk = pk;
	}
