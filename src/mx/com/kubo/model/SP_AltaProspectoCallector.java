...
@NamedNativeQueries({
	@NamedNativeQuery(
			...
			query = "call sp_alta_prospecto( :par_primer_nombre, :par_segundo_nombre , :par_ap_paterno , :par_ap_materno, :par_hs_vid , :par_hs_email , :par_url_origin , :par_phone_mobile, :par_area, :par_registration_reason ,:par_utm_medium , :par_utm_campaign )",
