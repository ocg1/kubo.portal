...
@NamedNativeQueries({
	@NamedNativeQuery(
			...
			resultClass = NotificaCreditosDesembolsadosTresDiasCollector.class,
			
			name = "collectorNotificaCreditosDesembolsadosTresDia",    
			 
			//  Par_Inserta: (I) inserta, (C) Consulta      Par_TipoNotifica: (S) SMS , (C) Correo
			query = "call SP_NOTIFICA_CREDITOS_DESEMBOLSADOS_TRES_DIAS( :Par_Inserta , :Par_TipoNotifica )",
...
@Entity
public final class NotificaCreditosDesembolsadosTresDiasCollector implements Serializable {
