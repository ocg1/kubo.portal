...
{
	protected void init_actualPage() 
	{
	...
	protected String cargaDocumento( FileUploadEvent event, Date fecha_carga )
	{
	...
	protected void procesaInfoArchivo (String pathFile, Date fecha_carga, String partner_id) 
	{				
