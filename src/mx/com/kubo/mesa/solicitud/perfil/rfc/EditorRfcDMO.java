package mx.com.kubo.mesa.solicitud.perfil.rfc;
...
public abstract class EditorRfcDMO 
implements EditorRfcIMO
{
	...
	{		
		...
		change_control_bean.setOrigValue(rfc);
		change_control_bean.setNewValue(rfc);
		change_control_bean.setNameTable("gn_natural_person");
		change_control_bean.setNameField("mx_rfc");
