...
public class NotificacionCancelacionCuentaInversionista extends NotificacionDMO
implements NotificacionIMO  
{
	public NotificacionCancelacionCuentaInversionista(ConexionIMO conexion_SMTP, Membership acreditado, MovimientosIMO movimiento)
	{
	...
	{	        	        	                                                                        
		...
		{			
	    	...
	    	body_text = leer_notificacion_HTML("jsf/docs/notificaciones/cancelacion_de_cuenta_inversionista.html");  
