...
public final class NotificacionDisposicionEfectivo extends NotificacionDMO
...
{	
	public NotificacionDisposicionEfectivo(ConexionIMO conexion_SMTP, Membership acreditado, MovimientosIMO movimiento)
	{
		...
		subject = "Notificación de Retiro de Efectivo" + " :: " + prospectus_id + " :: " + prospectName;
	}
	...
	{	        	        	                                                                        					
    	body_text = leer_notificacion_HTML("jsf/docs/notificaciones/disposicion_de_efectivo.html");  
