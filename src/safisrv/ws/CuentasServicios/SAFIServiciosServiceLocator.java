...
public class SAFIServiciosServiceLocator extends org.apache.axis.client.Service implements safisrv.ws.CuentasServicios.SAFIServiciosService {
    ...
    private java.lang.String SAFIServiciosSoap11_address = "http://192.168.200.12:8080/microfin/services/endPointSafi,";
    ...
    public safisrv.ws.CuentasServicios.SAFIServicios getSAFIServiciosSoap11() throws javax.xml.rpc.ServiceException {
    ...
    public safisrv.ws.CuentasServicios.SAFIServicios getSAFIServiciosSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            safisrv.ws.CuentasServicios.SAFIServiciosSoap11Stub _stub = new safisrv.ws.CuentasServicios.SAFIServiciosSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (safisrv.ws.CuentasServicios.SAFIServicios.class.isAssignableFrom(serviceEndpointInterface)) {
                safisrv.ws.CuentasServicios.SAFIServiciosSoap11Stub _stub = new safisrv.ws.CuentasServicios.SAFIServiciosSoap11Stub(new java.net.URL(SAFIServiciosSoap11_address), this);
                _stub.setPortName(getSAFIServiciosSoap11WSDDServiceName());
                return _stub;
            }
        }
